...
namespace DocumentLibrary.Editor
{
    ...
    {
        public event EventHandler OnSaveCalled;
        private mshtml.IHTMLDocument2 doc;
        private bool edits = true;
        public Editor()
        {
            InitializeComponent();
            ts.Renderer = new Office2007Renderer.Office2007Renderer();
        }
       ...
       Category("Toolbar")]
        ...
        {
            if (edits)
                doc.execCommand("InsertImage", true, null);
        }

        private void saveas_Click(object sender, EventArgs e)
        {
            OnSaveCalled(this, EventArgs.Empty);
        }
